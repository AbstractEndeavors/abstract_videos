...
class KeywordManager:
    ...
    def run(self, req=None, info_data=None):
        ...
        inputs, info_data, service_fn, bool_key = self.fetch_step_vars(req, info_data)
        ...
        updated_info = service_fn(info_data=info_data, **inputs)

        # 4) Persist immediately back to disk
        path = get_video_info_path(**updated_info)
